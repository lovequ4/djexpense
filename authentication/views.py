...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        context = {
            'fieldValues': request.POST   #用來保留輸入表單內容
        }
...
class RequestPasswordResetEmail(View):
    ...
    def post(self, request):
        ...
        if user.exists():
            ...
            email = EmailMessage(
                email_subject,
                'Hi , Please the click link below to reset your password \n'+reset_url,
                'noreply@semycolon.com',
                [email],
            )
            EmailThread(email).start()

        messages.success(request,'We have sent you na email to reset your password')
        return render(request, 'authentication/reset-password.html')  
